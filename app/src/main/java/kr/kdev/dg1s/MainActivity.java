...
public class MainActivity extends ActionBarActivity implements OnRefreshListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BreakfastTextView = (TextView) findViewById(R.id.breakfasttv);
    ...
    private void setAcademic() {
        TextView academicinfo = (TextView) findViewById(R.id.academictv);
        TextView academicdayinfo = (TextView) findViewById(R.id.academicdayinfo);

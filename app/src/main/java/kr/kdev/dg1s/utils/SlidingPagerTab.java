...
public class SlidingPagerTab extends HorizontalScrollView {
    ...
    public SlidingPagerTab(Context context) {
        this(context, null);
    }

    public SlidingPagerTab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingPagerTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.SlidingPagerTab);

        indicatorColor = a.getColor(R.styleable.SlidingPagerTab_indicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.SlidingPagerTab_underlineColor, underlineColor);
